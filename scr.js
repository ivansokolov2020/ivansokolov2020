...
function outArrayData(item, i, arr)
{
	...
	if (typeof(item)=="string"){
		...
		{
			string += "</table><br><table><tr><td>"+about[i] + "</td><td> "+item[0]+"</td></tr>";
			for(var j = 1; j<item.length; j++){
				string +="<tr><td></td>" + "<td>"  + item[j] + "</td></tr>";
			}
			string += "</table><br>";
		}
		else
...
function makeTableFromCountry(country)
{
	...
	return tab;
		...
		var out = this.countries.map(makeTableFromCountry);
...
function Change(){
  ...
  ["Мексика", "Мехико", "Южная Америка", "Америка", -9, "мексиканское песо", 
    ...
    this.changeCountries = function (data){
        ...
        {
             for (var j=0;j<this.countries[i][7].length;j++)
            {
                 this.countries[i][7][j]=this.countries[i][7][j].filter(countries=>this.countries[i][7][j][2]>data);
            }
        }
    }
}
var obj2 = new Change();
obj2.changeCountries(1960);
